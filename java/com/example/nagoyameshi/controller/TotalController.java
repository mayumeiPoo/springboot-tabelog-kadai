...
public class TotalController {
	...
	public String index(Model model) {
		...
		int manUserCount = userService.getManUserCount();
		int womanUserCount = userService.getWomanUserCount();
        ...
        model.addAttribute("manUserCount", manUserCount);
        model.addAttribute("womanUserCount", womanUserCount);
