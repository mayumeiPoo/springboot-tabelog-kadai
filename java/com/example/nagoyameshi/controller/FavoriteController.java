...
public class FavoriteController {
	...
	@PostMapping("/shop/{shopId}/favorite/create")
	public String create(@PathVariable(name = "shopId") Integer shopId,@AuthenticationPrincipal UserDetailsImpl userDetailsImpl,RedirectAttributes redirectAttributes,Model model) {
	...
	@PostMapping("/shop/{shopId}/favorite/{favoriteId}/delete")
